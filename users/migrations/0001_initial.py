    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admission_group', models.CharField(blank=True, choices=[('І-ша група з електробезпеки', 'I'), ('ІI-а група з електробезпеки', 'II'), ('ІII-ша група з електробезпеки', 'III'), ('ІV-а до 1000V група з електробезпеки', 'IV до 1kV'), ('ІV-а вище 1000V група з електробезпеки', 'IV вище 1kV'), ('V-а група з електробезпеки', 'V'), ('Не вибрано', 'Не вибрано')], default='Не вибрано', max_length=130, null=True)),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
