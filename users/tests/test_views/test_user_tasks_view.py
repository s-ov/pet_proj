...
class UserTasksViewTest(TestCase):
    ...
    def test_user_tasks_view_success(self):
        ...
        response = self.client.get(reverse('users:user_tasks', args=[self.user.id]))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'users/user_tasks.html')
    ...
    def test_user_tasks_view_user_not_found(self):
        ...
        response = self.client.get(reverse('users:user_tasks', args=[999]))
